-- ============================================================
-- COMBINED WACRM DATABASE MIGRATIONS (001 to 042)
-- Total migrations: 42
-- Generated at: 2026-09-22T13:30:15.221Z
-- ============================================================
...
-- >>> START OF MIGRATION: 002_pipelines_enhancements.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 002_pipelines_enhancements.sql <<<

-- >>> START OF MIGRATION: 003_broadcast_recipient_wamid.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 003_broadcast_recipient_wamid.sql <<<

-- >>> START OF MIGRATION: 004_contact_delete_set_null.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 004_contact_delete_set_null.sql <<<

-- >>> START OF MIGRATION: 005_broadcast_counts_incremental.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 005_broadcast_counts_incremental.sql <<<

-- >>> START OF MIGRATION: 006_automations.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 006_automations.sql <<<

-- >>> START OF MIGRATION: 007_automations_increment_counter.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 007_automations_increment_counter.sql <<<

-- >>> START OF MIGRATION: 008_profile_avatars_storage.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 008_profile_avatars_storage.sql <<<

-- >>> START OF MIGRATION: 009_message_actions.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 009_message_actions.sql <<<

-- >>> START OF MIGRATION: 010_flows.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 010_flows.sql <<<

-- >>> START OF MIGRATION: 011_profile_beta_features.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 011_profile_beta_features.sql <<<

-- >>> START OF MIGRATION: 012_flows_increment_counter.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 012_flows_increment_counter.sql <<<

-- >>> START OF MIGRATION: 013_whatsapp_config_phone_number_id_unique.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 013_whatsapp_config_phone_number_id_unique.sql <<<

-- >>> START OF MIGRATION: 014_message_templates_meta_integration.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 014_message_templates_meta_integration.sql <<<

-- >>> START OF MIGRATION: 015_whatsapp_config_registration.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 015_whatsapp_config_registration.sql <<<

-- >>> START OF MIGRATION: 016_flow_media.sql <<<
-- ============================================================
-- 016_flow_media.sql
--
...
-- >>> END OF MIGRATION: 016_flow_media.sql <<<

-- >>> START OF MIGRATION: 017_account_sharing.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 017_account_sharing.sql <<<

-- >>> START OF MIGRATION: 018_account_member_rpcs.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 018_account_member_rpcs.sql <<<

-- >>> START OF MIGRATION: 019_invitation_rpcs.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 019_invitation_rpcs.sql <<<

-- >>> START OF MIGRATION: 020_account_sharing_followups.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 020_account_sharing_followups.sql <<<

-- >>> START OF MIGRATION: 021_account_default_currency.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 021_account_default_currency.sql <<<

-- >>> START OF MIGRATION: 022_contact_phone_dedup.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 022_contact_phone_dedup.sql <<<

-- >>> START OF MIGRATION: 023_chat_media.sql <<<
-- ============================================================
-- 023_chat_media.sql
--
...
-- >>> END OF MIGRATION: 023_chat_media.sql <<<

-- >>> START OF MIGRATION: 024_member_presence.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 024_member_presence.sql <<<

-- >>> START OF MIGRATION: 025_filter_contacts_by_tags.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 025_filter_contacts_by_tags.sql <<<

-- >>> START OF MIGRATION: 026_api_keys.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 026_api_keys.sql <<<

-- >>> START OF MIGRATION: 027_notifications.sql <<<
-- ============================================================
-- NOTIFICATIONS
-- ============================================================
...
-- >>> END OF MIGRATION: 027_notifications.sql <<<

-- >>> START OF MIGRATION: 028_webhook_endpoints.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 028_webhook_endpoints.sql <<<

-- >>> START OF MIGRATION: 029_ai_reply.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 029_ai_reply.sql <<<

-- >>> START OF MIGRATION: 030_ai_knowledge.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 030_ai_knowledge.sql <<<

-- >>> START OF MIGRATION: 031_ai_reply_slot_grant.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 031_ai_reply_slot_grant.sql <<<

-- >>> START OF MIGRATION: 032_fix_ai_knowledge_membership.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 032_fix_ai_knowledge_membership.sql <<<

-- >>> START OF MIGRATION: 033_ai_reply_polish.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 033_ai_reply_polish.sql <<<

-- >>> START OF MIGRATION: 034_fix_profiles_update_rls.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 034_fix_profiles_update_rls.sql <<<

-- >>> START OF MIGRATION: 035_interactive_messages.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 035_interactive_messages.sql <<<

-- >>> START OF MIGRATION: 036_conversation_contact_dedup.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 036_conversation_contact_dedup.sql <<<

-- >>> START OF MIGRATION: 037_webhook_broadcast_reliability.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 037_webhook_broadcast_reliability.sql <<<

-- >>> START OF MIGRATION: 038_broadcast_resume.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 038_broadcast_resume.sql <<<

-- >>> START OF MIGRATION: 039_inbound_media_mirror.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 039_inbound_media_mirror.sql <<<

-- >>> START OF MIGRATION: 040_contact_business_scoped_user_id.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 040_contact_business_scoped_user_id.sql <<<

-- >>> START OF MIGRATION: 041_fix_broadcast_contact_id_ambiguity.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 041_fix_broadcast_contact_id_ambiguity.sql <<<

-- >>> START OF MIGRATION: 042_message_failure_reason.sql <<<
-- ============================================================
...
-- >>> END OF MIGRATION: 042_message_failure_reason.sql <<<
